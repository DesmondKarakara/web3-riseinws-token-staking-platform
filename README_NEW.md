# 🚀 Stellar Token Staking Platform

A **production-ready Web3 staking dApp** built on the Stellar blockchain with Soroban smart contracts. Connect your wallet, stake tokens, earn rewards, and track your portfolio—all in a secure, responsive interface.

**🌐 Live Site:** [NOT DEPLOYED - See DEPLOYMENT.md]  
**Status:** 🟠 Orange Belt Complete | 🟢 Green Belt Ready  
...
```typescript
// Stake tokens
await stake(amount: bigint): Promise<void>

// Unstake tokens
await unstake(amount: bigint): Promise<void>

// Claim rewards
await claimRewards(): Promise<void>
```

#### Reading Data
```typescript
// Get user's staking info
await getStakerInfo(address: string): Promise<StakerInfo>

// Get platform statistics
await getGlobalStats(): Promise<GlobalStats>
```

### Token Details
- **Token Used:** Stellar native asset (XLM/TOKEN)
- **Decimals:** 7 places (stroops)
- **Network:** Stellar Testnet
...
### Documentation
- Main README: How to install and run
- [PROGRESSION.md](./PROGRESSION.md): Belt system and achievements
- [TESTING_GUIDE.md](./TESTING_GUIDE.md): Testing documentation
- [client/CLAUDE.md](./client/CLAUDE.md): AI development notes

### Resources
- [Stellar Documentation](https://developers.stellar.org/)
- [Soroban Docs](https://developers.stellar.org/learn/fundamentals)
...
See [PROGRESSION.md](./PROGRESSION.md) for detailed roadmap.
...
- **GitHub:** [DesmondKarakara](https://github.com/DesmondKarakara)
- **Project:** [Token Staking Platform](https://github.com/DesmondKarakara/Web3_RiseInWS_Token-Staking-Platform_Day2_-2-)
- **Stellar:** [Testnet Contract](https://testnet.stellarexpert.com/account/CA5TD6RXA5ETYQ6UM46XMBAGFMIFGTUFKY6DIQQLOZ56EESSGJM5HQLU)

---

## 🙏 Acknowledgments

Built during the **Web3 RiseIn Workshop (Day 2)**
...
**Version:** 1.0.0  
**Status:** 🟠 Orange Belt Complete | Production Ready
